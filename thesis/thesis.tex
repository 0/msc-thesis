...
\definecolor{_red}{cmyk}{0.0, 1.0, 1.0, 0.2}
\newcommand{\red}[1]{\textcolor{_red}{#1}}
\definecolor{_blue}{cmyk}{1.0, 0.8, 0.0, 0.0}
\newcommand{\blue}[1]{\textcolor{_blue}{#1}}
...
\newcommand{\sumitem}[2]{\item \hyperref[#1]{#2} \DOTS \vref{#1}}
...
\newcommand{\explainsketch}{Intended solely as a sketch, so no axis values or color bars are provided.}
\newcommand{\explainparadiff}{For demonstration purposes, some parameters differ from the values in \vref{tab:model-sa0-harmonic-oscillator}.}
